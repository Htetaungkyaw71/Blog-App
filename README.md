...
**[Blog-app]** is a blog web application. User can create accounts, posts and users can add likes and comments for those posts. Built with ruby on rails.
...
```sh
  git clone git@github.com:Htetaungkyaw71/Blog-App.git
...
```sh
  bin/rails test test/models/blog_test.rb
```
